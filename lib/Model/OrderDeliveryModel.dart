...
class DeliveryOrdersModel {
  ...
  factory DeliveryOrdersModel.fromJson(Map<String, dynamic> json) => DeliveryOrdersModel(
    ...
    deliveryOrderDetail: List<DeliveryOrderDetail>.from(json["DeliveryOrderDetail"].map((x) => DeliveryOrderDetail.fromJson(x))),
    messageCode: json["MessageCode"],
  );

  Map<String, dynamic> toJson() => {
    "StatusCode": statusCode,
    "DeliveryOrderDetail": List<dynamic>.from(deliveryOrderDetail.map((x) => x.toJson())),
