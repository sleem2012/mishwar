...
import '../main.dart';
import 'DelveryUser/DeliveryOrderDetail.dart';
...
class _state extends State<Orders> {
  ...
  getOrder(var status_id) async {
    ...
    orders =
        await orderServices.GetOrders(prefs.getString("UserId"), status_id);
    setState(() {});
  }
                                  ...
                                  onTap: () {
                                    Navigator.push(
                                        ...
                                        GlobalFunction.route(
                                            OrderDetails(orderDetail:orders[index],)));
                                  },
                                  child: Container(
                                    margin: EdgeInsets.only(
                                                      ...
                                                      children: [
                                                        ...
                                                        Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                      DemoLocalizations.of(context).title['productsnumber']+"${orders[index].allQuantity}",
                                                                style: TextStyle(
                                                                    height: 1.5,
                                                                    fontSize:
                                                                        13,
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  Text(
                                                              //
                                                                  DemoLocalizations.of(context).title['Total']+ '  ${orders[index].totalValue}' +
                                    ...
                                    GestureDetector(
                                      ...
                                      child: DottedBorder(
                                          ...
                                          child: Container(
                                            ...
                                            child: Text(
                                              DemoLocalizations.of(context).title['shopnow'],
