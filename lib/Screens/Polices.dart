...
class _state extends State <Polices>{
  home h=new home();
ConfigServices configServices=new ConfigServices();
  Map<String,dynamic>data;
  loadData()async{
    data=await configServices.GetPolicyServices();
    setState(() {
    });
    print(data);
          ...
          children: [
            ...
            Expanded(
              child: Text(DemoLocalizations.of(context)
                  .title['policy'],style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.w500),
