                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            width: MediaQuery.of(context).size.width*.35,
                            child: Text(home.username,style: TextStyle(fontSize: 12),),
                          )
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                           // width: MediaQuery.of(context).size.width*.35,
                            child: Text(home.phone,textDirection:TextDirection.ltr,style: TextStyle(fontSize: 12),),
                          )
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            width: MediaQuery.of(context).size.width*.35,
                            child: Text(home.email,style: TextStyle(fontSize: 12),),
                          )
                        ],
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            width: MediaQuery.of(context).size.width*.35,
                            child: Text(DemoLocalizations.of(context)
                                .title['Deliverymethod'],style: TextStyle(fontSize: 12),),
                          ),
                          Container(
                            width: MediaQuery.of(context).size.width*.55,
                            child: Text(appConfig.prefs.getString('delmethodtext'),style: TextStyle(fontSize: 12),),
                          )
                        ],
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            width: MediaQuery.of(context).size.width*.35,
                            child: Text(DemoLocalizations.of(context)
                                .title['Paymentmethod'],style: TextStyle(fontSize: 12),),
                          ),
                          Container(
                            width: MediaQuery.of(context).size.width*.55,
                            child: Text(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                      children: [
                                                        Text(
                            c.price2.toString()+DemoLocalizations.of(context)
                                .title['currency'],style: TextStyle(color: Colors.black,fontSize: 11),),
               ...
               Container(
                 ...
                 child: Column(
                   children: [
                       ...
                       child:Column(
                         children: [
                           Container(
                             ...
                             child: Text(DemoLocalizations.of(context)
                                 .title['paymentDetails'],style: TextStyle(fontSize: 12),),
                           ),
                           Container(
                             height: 1,
                           ...
                           Row(
                             children: [
                               ...
                               Container(
                                 ...
                                 alignment: Alignment.center,
                                 child: Text(DemoLocalizations.of(context)
                                     .title['Tax']+"15%",style: TextStyle(fontSize: 12),),
                               ),
                               Container(
                                 width: MediaQuery.of(context).size.width*.3,
                                 height: MediaQuery.of(context).size.height*.04,
                                 ...
                                 alignment: Alignment.center,
                                 child: Text(DemoLocalizations.of(context)
                                     .title['Totaldemand'],style: TextStyle(fontSize: 12),),
                               ),
                             ],
                           ),
                           Row(
                           ...
                           Row(
                             children: [
                               Container(
                                 ...
                                 alignment: Alignment.center,
                                 child: Text(totalquantity.toString(),style: TextStyle(fontSize: 12),),
                               ),
                               Container(
                                 width: MediaQuery.of(context).size.width*.3,
                                 height: MediaQuery.of(context).size.height*.04,
                                 ...
                                 alignment: Alignment.center,
                                 child: Text(tax.toStringAsFixed(2)+DemoLocalizations.of(context)
                                     .title['currency'],style: TextStyle(fontSize: 12),),
                               ),
                               Container(
                                 width: MediaQuery.of(context).size.width*.3,
                                 height: MediaQuery.of(context).size.height*.04,
                                 ...
                                 alignment: Alignment.center,
                                 child: Text(((allPrice-tax).toStringAsFixed(2)).toString()+DemoLocalizations.of(context)
                                     .title['currency'],style: TextStyle(fontSize: 12),),
                               ),
                     ...
                     GestureDetector(
                       child: Container(
                         ...
                         child: Row(
                           ...
                           children: [
                             Text(DemoLocalizations.of(context)
                                 .title['Total']+" "+(allPrice).toString()+" "+DemoLocalizations.of(context)
                                 .title['currency'],style: TextStyle(color:Colors.white,fontSize: 12)),
                             Text(DemoLocalizations.of(context)
                                 .title['Continuetopurchase'],style: TextStyle(color:Colors.white,fontSize: 12))
                           ],
                         ),
                       ...
                       onTap: () async {
                         ...
                         for(int i=0;i<dataLocal.length;i++) {
                           ...
                           Items item = new Items(
                             ...
                             SubTotal: ((c.price2 * c.quantity) - ((c.price2 *
                                 c.quantity) * .15)).toString(),
                           );
                     ...
                     Map<String,dynamic>data=await orderServvices.MakeOrder(body);
                           if(data["StatusCode"]==200){
                             print(data);
                            // AddToCard(context);
                             //int quantity,int order_id,double subtotal,double totle,double tax
                             Navigator.push(context, GlobalFunction.routeBottom(OrderSuccess(totalquantity,data["Message"]["OrderNumber"],allPrice-tax,this.allPrice,this.tax)));
                             db.deleteCart();
                ...
                children: <Widget>[
                  Container(alignment: Alignment.center,child: Column(
                    children: [
                      ...
                      SizedBox(height: 10,),
                      Text(DemoLocalizations.of(context)
                          .title['operationaccomplishedsuccessfully'],style: TextStyle(color: Color(h.blueColor),fontSize: 14,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
                    ],
                  )),
                ],
              ),
